...
namespace ADO.NET_Homework.nwDataSetTableAdapters {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADO.NET_Homework.Properties.Settings.Default.NorthwindConnectionString;
        }
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ...
                " ProductName like @PdName";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PdName", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "ProductName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products where" +
                " UnitPrice between @up1 and @up2";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@up1", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@up2", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByLIKE(nwDataSet.ProductsDataTable dataTable, string PdName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((PdName == null)) {
                throw new global::System.ArgumentNullException("PdName");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(PdName));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual nwDataSet.ProductsDataTable GetDataByLIKE(string PdName) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((PdName == null)) {
                throw new global::System.ArgumentNullException("PdName");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUnitPriceBetween(nwDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> up1, global::System.Nullable<decimal> up2) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((up1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(up1.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((up2.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(up2.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual nwDataSet.ProductsDataTable GetDataByUnitPriceBetween(global::System.Nullable<decimal> up1, global::System.Nullable<decimal> up2) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((up1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(up1.Value));
            }
